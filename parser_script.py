...
class Autoru_parser:
	...
	def parse(x):
		...
		page_url =  'https://auto.ru/sankt-peterburg/cars/vaz/vesta/used/?page=2&output_type=list'
		...
		car_massive = {
		'focus' : 'https://auto.ru/sankt-peterburg/cars/ford/focus/2306579/used/?page=',
		'vesta' : 'https://auto.ru/sankt-peterburg/cars/vaz/vesta/used/?page=',
		'a4' : 'https://auto.ru/sankt-peterburg/cars/audi/a4/6297920/used/?page=',
		'camry' : 'https://auto.ru/sankt-peterburg/cars/toyota/camry/used/?page='}


		for i in range(0,page_ + 1):
